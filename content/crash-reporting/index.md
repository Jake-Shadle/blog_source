...
Also huge thanks to [@Gankra](https://github.com/Gankra), [@gabrielesvelto](https://github.com/gabrielesvelto), [@msirringhaus](https://github.com/msirringhaus), [@marti4d](https://github.com/marti4d), [@luser](https://github.com/luser), and the folks at Sentry for reviewing PRs, filing issues, providing additional feedback and discussion, and also implementation work, for example [@msirringhaus](https://github.com/msirringhaus) is responsible for basically all of the Linux crash dump writing implementation. And of course a lot of the work that already been done crates such as [minidump-common](https://github.com/rust-minidump/rust-minidump/tree/4a60e95fd1fceda67aa61cef85461d65457ab046/minidump-common).
